                ...
                <tbody>
                    ...
                    @forelse ($structuredData as $kecamatanName => $kecamatanInfo)
                        @foreach ($kecamatanInfo['kelurahan'] as $kelurahanName => $kelurahanInfo)
                            ...
                            @foreach ($kelurahanInfo['agama'] as $agamaName => $values)
                                <tr class="{{ $loop->parent->parent->iteration % 2 === 0 ? 'bg-white' : 'bg-blue-50' }}">
                                    ...
                                    <td class="border border-gray-200 px-3 py-2 text-left">{{ $agamaName }}</td>
                    ...
                    @endforelse
                    <tr class="bg-gray-200 font-bold"><td colspan="8" class="border border-gray-200 px-3 py-1 text-left text-xs">Sumber: Dinas Administrasi Kependudukan dan Pencatatan Sipil Tahun {{ $tahunAnalisis }}, diolah.</td></tr>
                </tbody>
            </table>
        </div>
    </div>
